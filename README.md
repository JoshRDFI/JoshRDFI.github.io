# Joshua Rogers - AI-Native GenAI Architect & ML Engineer Portfolio
...
This repository contains the source code for my portfolio website, which is built with simple HTML and CSS. It serves as the hosting location for the live site via GitHub Pages.
